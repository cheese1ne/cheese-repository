package com.cheese.db.server.spring.props;
 ...
 * @author sobann
 */
@ConfigurationProperties(prefix = "devbase-db.server")
public class DevBaseDBProps {
    ...
    private ExposerEnum exposerType;
    ...
    public ExposerEnum getExposerType() {
        return exposerType;
    }

    public void setExposerType(ExposerEnum exposerType) {
